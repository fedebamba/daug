...
# stuff ..............................
    ...
    "uuu-dist-and-max-of-both-ee-new-gauss_daug-005-rotation_daug-3-crop_daug-28-set-seed-with-origin": {
        "af_config": {
            "using_ensemble_entropy": True,
            "varratio_weight": 1,
            "distance_weight": 1,
    ...
    "uuu-dist-and-max-of-both-new-gauss_daug-005-rotation_daug-3-crop_daug-28-set-seed-with-origin": {
        "af_config": {
            "using_ensemble_entropy": False,
            "varratio_weight": 1,
            "distance_weight": 1,
    ...
    "uuu-dist-and-entro-new-gauss_daug-005-rotation_daug-5-crop_daug-28-set-seed-with-origin-and-prior-baseline": {
        "af_config": {
            "using_ensemble_entropy": False,
            "varratio_weight": 0,
            "distance_weight": 1,
    ...
    "uuu-dist-and-entro-new-gauss_daug-005-rotation_daug-5-crop_daug-28-set-seed-with-origin-and-prior-compensation": {
        "af_config": {
            "using_ensemble_entropy": False,
            "varratio_weight": 0,
            "distance_weight": 1,
    ...
    "uub-entropy-new-gauss_daug-005-rotation_daug-5-crop_daug-28-set-seed-with-origin-5-each": {
        "af_config": {
            "using_ensemble_entropy": False,
            "varratio_weight": 0,
            "distance_weight": 1e-7,
